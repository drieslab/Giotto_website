...
Install Giotto by following the [Giotto Installation Tutorial](installation.html).

~temporal~ Update GiottoClass and Giotto with dev version.
...
```{r, eval=FALSE}
devtools::install_github("wwang-chcn/Giotto@suite")
...
Please use this one in the event of R session aborted caused by segmentation fault.
