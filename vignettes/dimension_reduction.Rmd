...
```{r, eval=FALSE}
# would 'hvf' (highly variable feats) by default if available, but we pass NULL to `feats_to_use` to use all of them for this mini dataset
...
The first 20 PCs are a good cutoff. Following applications of this PCA such as umap or clustering should use only the first 20 PCs.
...
```{r, echo=FALSE, out.width="60%", fig.align="center"}
knitr::include_graphics("images/dimension_reduction/3_nmf.png")
```
...
```{r, echo=FALSE, out.width="60%", fig.align="center"}
knitr::include_graphics("images/dimension_reduction/4_pca_umap.png")
```
...
```{r, echo=FALSE, out.width="60%", fig.align="center"}
knitr::include_graphics("images/dimension_reduction/5_nmf_umap.png")
```
...
```{r, echo=FALSE, out.width="60%", fig.align="center"}
knitr::include_graphics("images/dimension_reduction/6_pca_tsne.png")
```
...
loaded via a namespace (and not attached):
  ...
  [4] magrittr_2.0.3              GiottoUtils_0.2.0           matrixStats_1.4.1          
  [7] compiler_4.4.1              png_0.1-8                   vctrs_0.6.5                
 [10] pkgconfig_2.0.3             SpatialExperiment_1.14.0    crayon_1.5.3               
 [13] fastmap_1.2.0               backports_1.5.0             magick_2.8.4               
 [16] XVector_0.44.0              labeling_0.4.3              utf8_1.2.4                 
 [19] rmarkdown_2.28              UCSC.utils_1.0.0            purrr_1.0.2                
 [22] xfun_0.47                   zlibbioc_1.50.0             beachmat_2.20.0            
 [25] GenomeInfoDb_1.40.0         jsonlite_1.8.9              DelayedArray_0.30.0        
 [28] BiocParallel_1.38.0         terra_1.7-78                irlba_2.3.5.1              
 [31] parallel_4.4.1              R6_2.5.1                    RColorBrewer_1.1-3         
 [34] reticulate_1.39.0           GenomicRanges_1.56.0        scattermore_1.2            
 [37] Rcpp_1.0.13                 SummarizedExperiment_1.34.0 knitr_1.48                 
 [40] R.utils_2.12.3              IRanges_2.38.0              FNN_1.1.4.1                
 [43] Matrix_1.7-0                igraph_2.0.3                tidyselect_1.2.1           
 [46] rstudioapi_0.16.0           abind_1.4-8                 yaml_2.3.10                
 [49] codetools_0.2-20            lattice_0.22-6              tibble_3.2.1               
 [52] Biobase_2.64.0              withr_3.0.1                 Rtsne_0.17                 
 [55] evaluate_1.0.0              pillar_1.9.0                MatrixGenerics_1.16.0      
 [58] checkmate_2.3.1             stats4_4.4.1                plotly_4.10.4              
 [61] generics_0.1.3              dbscan_1.2-0                sp_2.1-4                   
 [64] S4Vectors_0.42.0            ggplot2_3.5.1               munsell_0.5.1              
 [67] scales_1.3.0                GiottoData_0.2.15           gtools_3.9.5               
 [70] glue_1.8.0                  lazyeval_0.2.2              tools_4.4.1                
 [73] GiottoVisuals_0.2.5         data.table_1.16.0           ScaledMatrix_1.12.0        
 [76] RcppML_0.3.7                cowplot_1.1.3               grid_4.4.1                 
 [79] tidyr_1.3.1                 colorspace_2.1-1            SingleCellExperiment_1.26.0
 [82] GenomeInfoDbData_1.2.12     BiocSingular_1.20.0         cli_3.6.3                  
 [85] rsvd_1.0.5                  fansi_1.0.6                 S4Arrays_1.4.0             
 [88] viridisLite_0.4.2           dplyr_1.1.4                 uwot_0.2.2                 
 [91] gtable_0.3.5                R.methodsS3_1.8.2           digest_0.6.37              
 [94] BiocGenerics_0.50.0         SparseArray_1.4.1           ggrepel_0.9.6              
 [97] rjson_0.2.21                htmlwidgets_1.6.4           farver_2.1.2               
